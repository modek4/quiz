 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Kacper Grodzki');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Kacper Grodzki');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Quiz pdf');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Kacper Grodzki - www.modek4.com/quiz");
